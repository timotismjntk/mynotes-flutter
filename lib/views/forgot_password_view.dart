        ...
        if (state is AuthStateForgotPasword) {
          ...
          if (state.exception != null) {
            ...
            await showErrorDialog(context,
                'We could not process your request. Please make sure that you are a registered user, or if not, register an user by going back one step.');
          }
        }
      },
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text(
                  'If you have forgot your password, please enter your email address below. We will send you a password reset link.'),
              TextField(
